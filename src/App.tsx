      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Category 1 */}
            <div className="bg-gradient-to-br from-sky-400 to-blue-500 p-8 rounded-xl text-white hover:scale-105 transition-transform cursor-pointer shadow-lg">
            ...
            {/* Category 2 */}
            <div className="bg-gradient-to-br from-cyan-400 to-sky-500 p-8 rounded-xl text-white hover:scale-105 transition-transform cursor-pointer shadow-lg">
              <div className="text-3xl mb-4">💻</div>
              <h3 className="text-2xl font-bold mb-2">Technology</h3>
              <p className="text-cyan-100">Web Dev, Mobile Apps, Cloud</p>
            </div>

            {/* Category 3 */}
            <div className="bg-gradient-to-br from-blue-300 to-blue-500 p-8 rounded-xl text-white hover:scale-105 transition-transform cursor-pointer shadow-lg">
              <div className="text-3xl mb-4">📈</div>
            ...
            {/* Category 4 */}
            <div className="bg-gradient-to-br from-sky-300 to-cyan-500 p-8 rounded-xl text-white hover:scale-105 transition-transform cursor-pointer shadow-lg">
              <div className="text-3xl mb-4">🌟</div>
              <h3 className="text-2xl font-bold mb-2">Personal Development</h3>
              <p className="text-sky-100">Leadership, Productivity, Skills</p>
            </div>
          </div>
        </div>
      </section>
